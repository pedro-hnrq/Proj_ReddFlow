    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_birth', models.DateField(blank=True, null=True, validators=[account.validators.validate_age_18_or_above], verbose_name='Data de Nascimento')),
                ('sex', models.CharField(blank=True, choices=[('M', 'Masculino'), ('F', 'Feminino'), ('O', 'Outros')], max_length=1, verbose_name='Sexo')),
